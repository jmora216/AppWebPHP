    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href='?c=Admin&a=Index'>Taller 2 php</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link" href = '?c=Admin&a=Index'>Productos</a>
                        <a class="nav-link" aria-current="page" href = '?c=Carrito&a=ListarCarrito'">Carrito</a>
                        <a class="nav-link" href = '?c=Consultas&a=Index'>Usuarios</a>
                    </div>
                </div>
